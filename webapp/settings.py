...
INSTALLED_APPS = [
    ...
    'notebook',
    'parserapp',
    'django_unused_media', #/manage.py cleanup_unused_media
    'allauth',
    'allauth.account',
    'allauth.socialaccount',
    'captcha', #pip install  django-simple-captcha; -> migrate 
]
...
# redirect urls for alluath

LOGIN_REDIRECT_URL = 'app_start'
LOGIN_URL = 'account_login'
EMAIL_BACKEND = 'django.core.mail.backends.locmem.EmailBackend'
ACCOUNT_LOGOUT_REDIRECT_URL = 'app_start'
